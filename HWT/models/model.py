...
class TRGAN(nn.Module):
    ...
    def _generate_fakes(self, ST, eval_text_encode=None, eval_len_text=None, eval_encode_pos=None, resolution = 16):
        ...
        for batch_idx in range(self.fakes[0].shape[0]):
            for idx, fake in enumerate(self.fakes):
                fake = fake[batch_idx, 0, :, :eval_len_text[idx] * resolution]
                fake = (fake + 1) / 2
