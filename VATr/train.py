...
def main():
    ...
    parser.add_argument("--no_writer_loss", action='store_true') # self.args.no_writer_loss FALSE
    ...
    parser.add_argument("--is_cycle", default=True, type=bool)
    parser.add_argument("--is_CorrectorWD", default=True, type=bool)
